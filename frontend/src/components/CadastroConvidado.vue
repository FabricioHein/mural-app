<template>
  <div class="container">
    ...
    <div class="has-text-centered">
      <p>Já tem cadastro? <router-link to="/auth/signin" class="has-text-link">Faça login</router-link></p>
    </div>
    ...
    <form @submit.prevent="handleSubmit" class="box">
      ...
      <div class="field is-grouped is-grouped-centered">
        <div class="control">
          <button type="submit" class="button is-primary" :disabled="formData.password.length <= 4">Cadastrar Convidado</button>
        </div>
      </div>
    </form>
  </div>
  ...
  methods: {
    async handleSubmit() {
      ...
      try {
        ...
        // Se ocorrer um erro, você pode tratar aqui, como exibir um alerta
